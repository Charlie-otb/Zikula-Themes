 ...
 * @version    $Id: function.bt_adminlinks.php 486 2010-09-20 23:42:32Z mateo $
 */
...
function smarty_function_bt_adminlinks($params, &$smarty)
{
    ...
    if (ModUtil::available('News') && (SecurityUtil::checkPermission('News::', '::', ACCESS_EDIT) || SecurityUtil::checkPermission('Stories::Story', '::', ACCESS_EDIT))) {
        ...
        $linkoptions[] = array(null, __('Add an article', $dom), ModUtil::url('News', 'user', 'newitem'), $suboptions);
    }
    if (ModUtil::available('Pages') && SecurityUtil::checkPermission('Pages::', '::', ACCESS_EDIT)) {
        ...
        $linkoptions[] = array(null, __('Add a page', $dom), ModUtil::url('Pages', 'admin', 'newitem'), $suboptions);
    }
    ...
    if (ModUtil::available('Downloads') && SecurityUtil::checkPermission('Downloads::', '::', ACCESS_EDIT)) {
        ...
        $linkoptions[] = array(null, __('Add a download', $dom), ModUtil::url('Downloads', 'admin', 'edit'), $suboptions);
    }
    ...
    if (ModUtil::available('Feeds') && SecurityUtil::checkPermission('Feeds::', '::', ACCESS_EDIT)) {
        ...
        $linkoptions[] = array(null, __('Add a feed', $dom), ModUtil::url('Feeds', 'admin', 'newfeed'), $suboptions);
    }
